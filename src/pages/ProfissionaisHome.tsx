...
const ProfissionaisHome = () => {
  ...
  return <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative">
        <img alt="Os melhores profissionais" src="/lovable-uploads/af1a336b-3a05-412b-aa88-9b754e687d34.png" className="w-full h-15 sm:h-20 md:h-30 lg:h-20 object-cover" />
      </div>
