...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-4 flex flex-col items-center relative">
      {/* Botões flutuantes para lojas */}
      <div className="fixed top-4 right-4 z-50 flex flex-col gap-3">
        {/* Play Store */}
        <a
          href="https://play.google.com/store/apps/details?id=com.converta.sent"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-green-600 hover:bg-green-700 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-105"
        >
        ...
        {/* Apple Store */}
        <a
          href="https://apps.apple.com/us/app/sent-servi%C3%A7os/id6578414284"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-black hover:bg-gray-800 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-105"
        >
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="text-center space-y-4">
              <div className="relative overflow-hidden rounded-xl shadow-lg">
                <img 
                  ...
                  src="/lovable-uploads/8b9daf9f-6b9e-4f30-bc40-3b49c2d48c42.png" 
                />
              </div>
              <div>
            ...
            <div className="text-center space-y-4">
              <div className="relative overflow-hidden rounded-xl shadow-lg">
                <img 
                  alt="Cliente" 
                  className="w-full h-28 sm:h-32 md:h-40 object-cover" 
                  src="/lovable-uploads/8a0f17a6-7fe4-45b1-918f-1d0c670cac7c.png" 
                />
              </div>
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-black mb-3">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link to="/terms">
            <Button 
              variant="outline" 
              size="sm"
              className="text-xs px-3 py-1 h-8 border-blue-200 text-blue-600 hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 rounded-full"
            >
